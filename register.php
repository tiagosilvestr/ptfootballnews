        ...
        <div class="col-lg-4">
			...
			<select name="country" id="country">
				...
				while($row = $result->fetch_assoc()) {
					print '<option value="' . $row["iso"] . '">' . $row["name"] . '</option>';
				}
			print '
			</select>
            <br>
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql .= " OR username='" .  $_POST['username'] . "'";
                $result = $conn->query($sql);
                ...
                if ($row["email"] == '' || $row["username"] == '') {
                    ...
                    $sql  = "INSERT INTO user (email, username, password, country)";
                    $sql .= " VALUES ('" . $_POST['email'] . "', '" . $_POST['username'] . "', '" . $pass_hash . "', '" . $_POST['country'] . "')";
                    $result = $conn->query($sql);
